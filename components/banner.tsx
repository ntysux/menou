...
export default function Banner() {
  return (
    <div className="relative mx-5 rounded-lg isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      <div
      ...
      <div className="flex flex-1 justify-end">
        <button type="button" className="-m-3 p-3">
          <IconX strokeWidth='3' size='18px' className="text-neutral-800" />
        </button>
      </div>
    </div>
  )
