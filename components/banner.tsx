...
export default function Banner() {
  ...
  return (
    ...
    >
      <div className="relative mx-3 rounded-lg isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1 sm:max-w-5xl sm:mx-auto">
        <div
